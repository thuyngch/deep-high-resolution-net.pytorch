...
class JointsDataset(Dataset):
	...
	def __getitem__(self, idx):
		if self.multi_person:
			return self._getitem_multi_person(idx)
		else:
			return self._getitem_single_person(idx)

	def _getitem_single_person(self, idx):
